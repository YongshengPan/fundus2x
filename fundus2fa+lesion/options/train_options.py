...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--continue_train',default=1, action='store_true', help='continue training: load the latest model')
        ...
        self.parser.add_argument('--kaug', type=int, default=0)
        ...
        # self.parser.add_argument('--no_vgg_loss', default=1, help='if specified, do *not* use VGG feature matching loss')   
